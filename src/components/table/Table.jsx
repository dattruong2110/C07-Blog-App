...
const Table = ({ columns = [], data = [], title, subTitle }) => {
  const Search = () => {
    return (
      <>
        <form>
          <div className="px-4 py-2 flex gap-2 items-center justify-center text-sm text-gray-900 bg-gray-50 rounded focus:ring-blue-500 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500">
